  ...
  // },
  {
    ...
    children: [
      { label: "Beranda", href: "/accounting/beranda" },
      {
        ...
        href: "/accounting/jurnal-keuangan",
        children: [
          ...
          { label: "Jurnal Keuangan", href: "/accounting/jurnal-keuangan" },
          { label: "Buku Besar", href: "/accounting/buku-besar" },
          { label: "Laporan Laba Rugi", href: "/accounting/laba-rugi" },
          { label: "Neraca", href: "/accounting/neraca-baru" },
          { label: "Kas & Bank", href: "/accounting/kas-bank" },
        ],
      },
      { label: "Pendapatan", href: "/accounting/pendapatan" },
      // { label: "Neraca 2023", href: "/accounting/neraca2023" },
      { label: "Jurnal Keuangan (Lama)", href: "/accounting/neraca" },
      { label: "Laporan Laba Rugi 2023", href: "/accounting/laba-rugi-2023" },
      { label: "Laporan Hasil Usaha", href: "/accounting/hasil-usaha" },
      { label: "Piutang", href: "/accounting/piutang" },
      {
        label: "Daftar Invoice/Kwitansi Pelatihan",
        href: "/accounting/ik-pelatihan",
      },
      {
        label: "Daftar Invoice/Kwitansi Non-Pelatihan",
        href: "/accounting/ik-non-pelatihan",
      },
      {
        label: "Rekap Pengiriman dan Bupot Pajak",
        href: "/accounting/bupot-pajak",
      },
      {
        label: "List UMK",
        href: "/accounting/umk",
