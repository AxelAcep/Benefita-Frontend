...
const DUMMY_DATA: JabatanTeknis[] = [
  {
    id: 1,
    noInduk: "PR00621",
    perusahaan: "PT. ABC",
    nama: "Syarif Faisal Alkadrie",
  ...
  },
  {
    ...
    perusahaan: "PT. BCA",
    nama: "Dwi Ardama",
    jabatan: "Enviro Manager",
    noTelepon: "081315472799",
    email: "-",
  },
  {
    id: 3,
    noInduk: "PR02434",
    perusahaan: "PT. XYZ",
    nama: "Lucas Prana Sunarja",
    jabatan: "EHS Division Head",
    noTelepon: "-",
    email: "-",
  },
  {
...
export default function DaftarJabatanTeknisPage() {
