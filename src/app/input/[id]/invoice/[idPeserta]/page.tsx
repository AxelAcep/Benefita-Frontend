...
export interface CetakInvoiceData {
  // Identitas Invoice
  tanggal: string;
  data1: string;
  noInvoice: string;
...
interface PageCetakInvoiceProps {
  initialData?: Partial<CetakInvoiceData>;
  onBack?: () => void;
  onSimpan?: (data: CetakInvoiceData) => void;
  onCetak?: (data: CetakInvoiceData) => void;
}
...
const DEFAULT_DATA: CetakInvoiceData = {
  tanggal: "14 April 2026",
  data1: "23420",
  noInvoice: "0029/INV/REG-WM-01/V/26",
  data2: "2026279",
  data3: "202605",
  kode: "WM-01",
  noPO: "",
  ...
  return (
    <div className="flex items-center border-b border-zinc-100 last:border-b-0 py-1">
      ...
      <input
        ...
        className="flex-1 px-4 py-2 text-xs text-zinc-700 outline-none focus:bg-emerald-50/30 transition-all placeholder:text-zinc-300 bg-transparent"
      />
    </div>
  );
}
...
export default function PageCetakInvoice({
  initialData = {},
  onBack,
  onSimpan,
  onCetak,
}: PageCetakInvoiceProps) {
  const [form, setForm] = useState<CetakInvoiceData>({
    ...DEFAULT_DATA,
    ...initialData,
  });
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        {/* ── Identitas Invoice ── */}
        <SectionCard title="Identitas Invoice">
